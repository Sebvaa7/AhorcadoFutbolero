const palabras = [
  ...
  { palabra: "RAUL", pistas: ["España", "7 de leyenda", "Real Madrid"] },
  ...
  { palabra: "DELPIERO", pistas: ["Italia", "Juve 10", "Tiro curvo"] },
  ...
  { palabra: "KAKA", pistas: ["Brasil", "Cristiano elegante", "Milan"] },
  { palabra: "CARLOS", pistas: ["Brasil", "Tiro imposible", "Roberto"] },
  ...
  { palabra: "DISTEFANO", pistas: ["Argentina/España", "Leyenda Madrid", "Balón de Oro"] },
  ...
  { palabra: "ETOO", pistas: ["Camerún", "Barça/Inter", "Velocidad"] },
  { palabra: "DROGBA", pistas: ["Costa Marfil", "Final UCL 2012", "Fuerza"] },
  { palabra: "WEAH", pistas: ["Liberia", "Balón Oro", "Presidente"] },
  ...
  { palabra: "MAKELELE", pistas: ["Francia", "3 piernas", "Recuperador"] },
  { palabra: "AGUERO", pistas: ["Argentina", "Gol último minuto", "City ídolo"] },
